...
describe('tribonacci', function () {
	const tribonacci = require('../katas/TribonacciSequence').tribonacci;
	it('0', function () {
		assert.deepEqual(tribonacci([0, 0, 0], 0), []);
	});
	...
	it('2', function () {
		assert.deepEqual(tribonacci([1, 0, 1], 2), [1, 0]);
	});

	it('3', function () {
		assert.deepEqual(tribonacci([0, 0, 1], 3), [0, 0, 1]);
	});
	...
	it('Basic tests', function () {
		...
		assert.deepEqual(
			...
			[
				0.5, 0.5, 0.5, 1.5, 2.5, 4.5, 8.5, 15.5, 28.5, 52.5, 96.5, 177.5, 326.5, 600.5, 1104.5, 2031.5, 3736.5, 6872.5, 12640.5, 23249.5, 42762.5, 78652.5, 144664.5, 266079.5, 489396.5, 900140.5,
